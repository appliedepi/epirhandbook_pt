...
table <- linelist %>% 
  ...
  add_header_row(
    ...
    values = c("Hospital",     # Valores dos cabeçalhos para cada coluna abaixo
               ...
               "Recuperados",    # Este será a direção para cabeçalho de nível superior para esta e a próxima coluna
               "",
               "",
               "Óbito",         # Este será a direção para cabeçalho de nível superior para esta e a próxima coluna
