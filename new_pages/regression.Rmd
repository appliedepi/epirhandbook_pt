...
Para alterar o nível base de comparação de dada variável, garanta que a coluna é da classe Factor e altere a primeira posição ao nível desejado utilizando a função `fct_relevel()` (veja a página sobre [Factors]). Por exemplo, abaixo nós adaptamos a coluna `age_cat` e escolhemos "20-29" como nível base antes de aplicar estes dados na função `glm()`.
