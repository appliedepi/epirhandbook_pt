...
**RStudio** - RStudio é um programa que oferece uma interface gráfica com o usuário (GUI, do inglês *Graphical User Interface*) para facilitar a utilização do **R**. Mais detalhes [na seção do RStudio](#rstudio).
