...
Essa linelist inclui cinco variáveis do tipo "sim/não" ("yes/no") a respeito dos sintomas relatados. Nós vamos precisar transformar essas variáveis um puco para poder utilizar o pacote **ggupset** para fazer nosso gráfico. Confira os dados (role para a direita para ver as variáveis dos sintomas).
