...
Utilize o pacote **linelist** do R e sua função `clean_variable_spelling()` para limpar um data frame com um *dicionário de limpeza*. O pacote **linelist** é  desenvolvido por [RECON](https://github.com/reconhub/linelist) - o Consórcio R Epidemics.
...
Para uma maneira rápida de fazer quebras e rotular vetores, use algo como abaixo. Veja a página [R - o básico] para referências em `seq()` e `rep()`.
