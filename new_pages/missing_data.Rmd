...
Então nóstraçamos um gráfico das proporções dos campos em branco como uma linha, de acordo com a semana. A página sobre [básico do ggplot] pode ser utilizada se você não tiver familiaridade com o pacote **ggplot2** de plotagem.
