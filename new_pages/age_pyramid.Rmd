...
As pirâmides demográficas são úteis para mostrar as distribuições de idade e de sexo. Um código semelhante pode ser usado para visualizar os resultados de perguntas de pesquisa do tipo Likert (por exemplo "Concordo plenamente", "Concordo", "Neutro", "Discordo",  "Discordo totalmente"). Nesta página, cobrimos o seguinte:  
