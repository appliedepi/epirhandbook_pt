...
pacman::p_load(
  ...
  tmap,          # para produzir mapas simples, funciona tanto para mapas interativos quanto estáticos 
...
Novamente, esses dados podem ser baixadados do site da HDX (link [aqui](https://data.humdata.org/dataset/sierra-leone-population)) ou pelo pacote **epirhandbook** explicado [nessa página][Download do manual e dados]. Usamos `import()` para carregar o arquivo .csv. Também passamos o arquivo importado para `clean_names()` para padronizar a sintaxe dos nomes das colunas.   
