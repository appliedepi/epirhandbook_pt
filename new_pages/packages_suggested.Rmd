...
* Se vários pacotes têm funções com o mesmo nome, o mascaramento (*masking*) das funções pode ocorrer entre os pacotes. Ou seja, quando a função do pacote mais recentemente carregado prevalece. Leia mais na página [R- o básico]. Considere o uso do pacote **conflicted** para gerenciar tais conflitos.  
