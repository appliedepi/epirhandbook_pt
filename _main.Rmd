...
knitr::include_graphics(here::here("images", "epi_r_handbook_banner_beige_1500x500.png"))
# library(knitr)
...
2. Fornecer uma função  `element_()` para o argumento  
...
3. Dentro da função `element_()`, escreva atribuições de argumentos para fazer os ajustes finos que você deseja  
